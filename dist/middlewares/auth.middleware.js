...
var authMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var Authorization, secretKey, verificationResponse, userId, userRepository, findUser, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                secretKey = config_1["default"].get('secretKey');
                return [4 /*yield*/, jsonwebtoken_1["default"].verify(Authorization, secretKey)];
            case 1:
                verificationResponse = (_a.sent());
                userId = verificationResponse.id;
                userRepository = (0, typeorm_1.getRepository)(users_entity_1.UserEntity);
                return [4 /*yield*/, userRepository.findOne(userId, { select: ['id', 'email', 'password'] })];
            case 2:
                findUser = _a.sent();
                if (findUser) {
                    req.user = findUser;
